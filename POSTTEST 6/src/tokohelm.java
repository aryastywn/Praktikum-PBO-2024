...
public final class tokohelm implements DataHandler {
    ...
    public void simpanData() {
        try {
            ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("data_helm.dat"));
            outputStream.writeObject(dataHelm);
            outputStream.close();
            System.out.println("Data helm berhasil disimpan.");
        } catch (IOException e) {
            System.out.println("Terjadi kesalahan saat menyimpan data helm: " + e.getMessage());
        }
    }
    ...
    public void muatData() {
        try {
            ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("data_helm.dat"));
            Object obj = inputStream.readObject();
            if (obj instanceof ArrayList) {
                dataHelm = (ArrayList<Helm>) obj;
                System.out.println("Data helm berhasil dimuat.");
            } else {
                System.out.println("Format data helm tidak sesuai.");
            }
            inputStream.close();
        } catch (IOException | ClassNotFoundException e) {
            System.out.println("Terjadi kesalahan saat memuat data helm: " + e.getMessage());
        }
    }
